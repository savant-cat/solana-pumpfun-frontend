...
export const AdminSocialData = [
    { id: "telegram", icon: <FaTelegramPlane />, url: "https://t.me/@DevCutup/" },
    { id: "youtube", icon: <FaYoutube />, url: "https://www.youtube.com/channel/" },
    { id: "twitter", icon: <FaTwitter />, url: "https://x.com/januscutup/" },
    { id: "github", icon: <TbBrandGithubFilled />, url: "https://github.com/cutupdev/" },
    { id: "domain", icon: <TbWorld />, url: "https://www.devcutup.com/" },
]
